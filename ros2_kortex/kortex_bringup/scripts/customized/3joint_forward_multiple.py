...
WAYPOINTS = [
    np.array([-2.5386, -1.6548, -0.5769, -2.5331, 2.5127, 2.09, -1.0092]),
    np.array([-4.1285, -1.6838, 1.0524, -2.2518, 1.0291, -1.8627, -1.5699]),
    np.array([0.6463, 2.24, 1.7486, -2.1624, 2.1282, 1.4655, -1.5833]),
]
# ==============================================
